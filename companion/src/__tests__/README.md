...
- `mcp-babysitter.test.ts` verifies the shared companion restart policy that both the manual supervisor and the MCP bridge use for startup grace, repeated health failures, forced child-exit restarts, and restart-storm throttling.
