...
- `companion-agentic.e2e.test.ts` boots an isolated companion process plus a local Moonshine mock, then drives the public HTTP surfaces for `/tools/preflight`, `/mcp`, agentic `/v1/chat/completions`, Babelfish, agent swarm, Daydream, TTS preview, and preview-first range edits.
